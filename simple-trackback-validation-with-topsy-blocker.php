...
function stbv_main($incomingTB) {
	...
	####################################
	# If Trackback contains "topsy.com/trackback", it will be marked ad spam.
	####################################
	if (!$stbv_val['is_spam'] && (stripos($stbv_val['comment_author_url'], 'topsy') !== false || 
			stripos($stbv_val['comment_post_permalink'], 'wurde auf Twitter') || 
			stripos($stbv_val['comment_author'], 'Topsy'))) {
		$stbv_val['log_info'][]['warning'] = 'Author\'s URL contains topsy.com Trackback link'; 
...
function stbv_adminOptions() {
	...
	<div class="wrap">
		...
		<h2>Simple Trackback Validation with Topsy Blocker</h2>
		...
		<dd>
			<ul>
				<li><a class="lhome" href="http://www.sjmp.de/blogging/simple-trackback-validation-with-topsy-blocker/">Plugin's Homepage</a></li>
		...
		<dd>
			<ul>
				<li><a class="lpaypal" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3736248">Donate via PayPal</a></li>
			</ul>			
		...
		<dd>
			<ul>
				<li><a class="lhome" href="http://www.sjmp.de/internet/subscribe-to-comments-mit-double-opt-in-pruefung/">Subscribe to Comments with Double Opt-In Feature</a></li>
			</ul>
		</dd>
		</dl>
		...
		<p style="margin-top: 30px; text-align: center; font-size: .85em;">&copy; Copyright 2010&nbsp;&nbsp;<a href="http://www.sjmp.de">Tobias Koelligan</a></p>
